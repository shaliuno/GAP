        ...
        inp_thread = new Thread(() => {
            while (ui.b_running) {
                ...
                if (ui.sett.b_use_left_flasks 
                    ...
                    Keyboard.KeyPress(ui.hot_keys.use_flask_in_slot1.Key);
                    //ui.SendToBots(Opcode.KeyPress, ui.sett.flask_0_key.ToByteArr());
                    Thread.Sleep(60 + R.Next(0, 60));
                    Keyboard.KeyPress(ui.hot_keys.use_flask_in_slot2.Key);
                ...
                if (ui.sett.b_use_right_flasks
                    ...
                    Keyboard.KeyPress(ui.hot_keys.use_flask_in_slot4.Key);
                    //ui.SendToBots(Opcode.KeyPress, Keys.F7.ToByteArr());
                    Thread.Sleep(60 + R.Next(0, 60));
                    Keyboard.KeyPress(ui.hot_keys.use_flask_in_slot5.Key);
